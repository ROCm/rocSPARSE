...
def runCI =
{
    ...
    prj.paths.build_command = './install.sh --matrices-dir-install ${JENKINS_HOME_DIR}/rocsparse_matrices && ./install.sh -kpc --matrices-dir ${JENKINS_HOME_DIR}/rocsparse_matrices'
