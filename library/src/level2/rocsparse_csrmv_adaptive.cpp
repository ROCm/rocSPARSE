...
#include "rocsparse.h"
#include "rocsparse_csrmv_adaptive.hpp"
...
extern "C" rocsparse_status rocsparse_scsrmv_adaptive(rocsparse_handle handle,
                                                      rocsparse_operation trans,
                                                      rocsparse_int m,
                                                      rocsparse_int n,
                                                      rocsparse_int nnz,
...
{
    return rocsparse_csrmv_adaptive_template<float>(
        handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, x, beta, y, info);
}

extern "C" rocsparse_status rocsparse_dcsrmv_adaptive(rocsparse_handle handle,
                                                      rocsparse_operation trans,
                                                      rocsparse_int m,
                                                      rocsparse_int n,
                                                      rocsparse_int nnz,
                                                      ...
                                                      const rocsparse_csrmv_info info)
{
    return rocsparse_csrmv_adaptive_template<double>(
        handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, x, beta, y, info);
}
